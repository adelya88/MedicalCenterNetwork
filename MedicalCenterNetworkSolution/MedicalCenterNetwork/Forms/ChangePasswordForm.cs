...
namespace MedicalCenterNetwork.Forms
{
    public partial class ChangePasswordForm : Form
    {
        ...
        private void AddToolTips()
        {
            ...
            // Подсказки для полей
            toolTip.SetToolTip(textBoxNewPassword, "Пароль должен содержать не менее 6 символов");
        ...
        private bool ValidateForm()
        {
            ...
            {
                errorProvider.SetError(textBoxNewPassword, "Пароль должен быть не менее 6 символов");
                if (firstErrorControl == null) firstErrorControl = textBoxNewPassword;
                isValid = false;
            }
